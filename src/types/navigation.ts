...
export const getMainTabsForRole = (role?: string): MainNavTabItem[] => {
  if (role === 'phc_controller') {
    return [
      ...
      },
      {
        ...
        descriptionMarathi: 'मास्टर डेटा व प्रशासन नियंत्रण',
      },
    ];
  }

  // Subcentre Employee: show only two main menu items (Data Entry & Reports)
  return [
    {
      id: 'data-entry',
      labelMarathi: 'Data Entry',
