...
const INITIAL_AUDIT_LOGS: SystemAuditLog[] = [
  ...
  },
  {
    ...
    action: 'LOGIN',
    module: 'Authentication',
    record_id: 'usr-sc-002',
    record_description: 'उपकेंद्र आरोग्य सेविका लॉगिन',
    old_values: null,
    new_values: { session: 'active', subcentre: 'आरोग्य उपकेंद्र, जातेगाव' },
    ip_address: null,
  ...
  },
  {
    ...
    record_id: 'emp11111-1111-4111-8111-111111111111',
